...
function sendServerStartEmail() {
    ...
    const htmlContent = `
        <h2>Server Start Notification</h2>
        <p>The server has started successfully.</p>
        <ul>
            <li><strong>Start Time:</strong> ${formattedStartTime}</li>
            <li><strong>HTTPS Port:</strong> ${HTTPS_PORT}</li>
            <li><strong>HTTP Port (for redirection):</strong> ${HTTP_PORT}</li>
            <li><strong>Node.js Version:</strong> ${process.version}</li>
            <li><strong>Operating System:</strong> ${process.platform}</li>
            <li><strong>Server IP:</strong> ${getServerIP()}</li>
        </ul>
    `;
